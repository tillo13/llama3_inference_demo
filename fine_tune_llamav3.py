...
print(f"[INFO] Setting up Hugging Face cache...")
...
class MetricsLogger(TrainerCallback):
    ...
    def on_log(self, args, state, control, logs=None, **kwargs):
        ...
        print(f"[INFO] Epoch {epoch}: training_loss = {logs.get('loss', 'N/A')}, eval_loss = {logs.get('eval_loss', 'N/A')}, learning_rate = {logs.get('learning_rate', 'N/A')}, time_taken = {time.time() - self.start_time}")
